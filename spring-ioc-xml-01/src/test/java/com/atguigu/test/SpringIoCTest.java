...
import com.atguigu.ioc_04.JavaBean2;
import com.atguigu.ioc_05.JavaBean3;
...
//        JavaBean bean1 = applicationContext.getBean(JavaBean.class);
    ...
    public void test_05(){
        ...
        //2.读取组件
         JavaBean3 javaBean = applicationContext.getBean("javaBean3", JavaBean3.class);

        System.out.println("javaBean = " + javaBean);

        //TODO: FactoryBean工厂也会加入到ioc容器! 名字  &id
        Object bean = applicationContext.getBean("&javaBean3");
